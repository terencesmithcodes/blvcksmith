    ...
    >
      ...
      <div className="w-full">
        ...
        <input
          ...
          required
          className="mt-1 block w-full border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:border-accent focus:ring-accent px-3 py-2 bg-white text-secondary appearance-none rounded-none focus-visible:outline-none text-base"
